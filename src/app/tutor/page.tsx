...
export default async function TutorPage() {
  ...
  // 2. Student visiting tutor area -> redirect to /student
    ...
    <div className="min-h-screen bg-slate-50 text-slate-900 flex flex-col">
      ...
      <main className="flex-1 max-w-5xl w-full mx-auto px-4 py-12">
        <div className="bg-white p-8 rounded-xl border border-slate-200 shadow-xs max-w-2xl mx-auto">
          ...
          <h1 className="text-2xl font-bold text-slate-900 mb-2">Tutor Area</h1>
          <p className="text-slate-600 mb-6">Authenticated as tutor.</p>
